...
function Anime_elements() {
  ...
  return (
    ...
    <img src={c2} ref={anime2} className="ggg absolute w-30 left-140 top-20 rotate-45 max-[1000px]:left-100 max-[770px]:left-140 max-[710px]:w-20 max-[670px]:left-120 max-[670px]:top-10 max-[580px]:left-100  max-[500px]:left-[73%] max-[460px]:w-15 max-[380px]:top-40 max-[380px]:left-[80%] max-[330px]:top-20 md:top-5"  alt="" />
    </div>
    </>
  )
}
