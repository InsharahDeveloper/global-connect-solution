  ...
  return (
    <div className="max-w-4xl pp-text mx-auto px-6 py-12 text-gray-800">
      ...
      <p className="mb-4">
        ...
        and any message you send through contact forms. We may also collect
        non-personal information like browser type and usage data.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">2. How We Use Your Information</h2>
      <p className="mb-4">
        We use the information to improve our website, respond to inquiries,
        provide services, and enhance user experience.
      </p>
      ...
      <p className="mb-4">
        ...
        that may collect limited data according to their own privacy policies.
      </p>
